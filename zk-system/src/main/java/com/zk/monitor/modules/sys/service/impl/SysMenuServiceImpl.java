...
import com.zk.monitor.common.constant.MenuConstant;
...
import com.zk.monitor.modules.sys.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements ISysMenuService {
    ...
    @Override
    public AjaxResult removeMenuById(Serializable id) {
        List<Integer> idList =
        ...
        if (CollUtil.isNotEmpty(idList)) {
            return AjaxResult.error("菜单含有下级不能删除");
        }
        return AjaxResult.ok(this.removeById(id));
    }
