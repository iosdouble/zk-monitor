package com.zk.monitor.modules.security.config;

import com.zk.monitor.modules.security.UserDetailsServiceImpl;
import com.zk.monitor.modules.security.code.img.ImageCodeFilter;
import com.zk.monitor.modules.security.code.sms.SmsCodeAuthenticationSecurityConfig;
import com.zk.monitor.modules.security.code.sms.SmsCodeFilter;
import com.zk.monitor.modules.security.filter.PreJwtAuthenticationTokenFilter;
import com.zk.monitor.modules.security.handle.PreAccessDeineHandler;
import com.zk.monitor.modules.security.handle.PreAuthenticationEntryPointImpl;
...
/**
 * com.zk.monitor.modules.security.config
...
public class PreWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/login/**", "/mobile/login/**", "/favicon.ico", "/socialSignUp", "/bind", "/register/**","/dump/**").anonymous()
