package com.zk.monitor.log.aspect;
...
import com.zk.monitor.common.utils.IPUtil;
import com.zk.monitor.log.domain.SysLog;
import com.zk.monitor.log.event.SysLogEvent;
import com.zk.monitor.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.zk.monitor.log.annotation.SysOperaLog)")
    ...
    public void doAfterReturning(Object ret) {
        ...
        // 处理完请求，返回内容
        AjaxResult r = Convert.convert(AjaxResult.class, ret);
        if (r.getCode() == 200) {
            // 正常返回
            sysLog.setType(1);
        } else {
